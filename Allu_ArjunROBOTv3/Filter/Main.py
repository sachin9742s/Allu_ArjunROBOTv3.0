...
from Allu_ArjunROBOTv3.0 import get_filter_results, get_file_details, is_subscribed, get_poster
from Allu_ArjunROBOTv3.0 import RATING, GENRES, HELP, ABOUT
import random
BUTTONS = {}
BOT = {}
...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 5: 
            ...
            if poster:
                await message.reply_photo(photo=poster, caption=GD_FILMCLUB, reply_markup=InlineKeyboardMarkup(buttons))

            else:
                await message.reply_text(GD_FILMCLUB, reply_markup=InlineKeyboardMarkup(buttons))
            return
